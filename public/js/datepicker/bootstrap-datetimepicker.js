...
!function( $ ) {
	...
	var Datetimepicker = function(element, options) {
		...
		this.component = this.element.is('.date') ? this.element.find('.add-on .fa fa-th, .add-on .fa fa-time, .add-on .fa fa-calendar').parent() : false;
		this.componentReset = this.element.is('.date') ? this.element.find('.add-on .fa fa-remove').parent() : false;
