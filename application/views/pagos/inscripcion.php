<div class="container">
    ...
    <div class="well">
        ...
        <h2>Concentrado Mensual de Pagos de Inscripci&oacute;n<p><small>Seleccione Periodo</small></p></h2>
            </br>
                <!-- Form DateTime Pickers -->
                <div class="row-fluid">
                    <form id="inscripcionform" action="<?php echo URL; ?>pagos/inscripcion" class="form-horizontal" method="POST">           
    ...
    <!-- main content output -->
    <div>
        <table class="table table-striped table-bordered table-hover" id="inscripciones-table" style="background-color:white;">
            <thead style="background-color: #ddd; font-weight: bold;">
            <tr>
                <td>Num. Cliente</td>
                <td>Nombre</td>
                <td style="text-align:center;">Fecha de Inscripci&oacute;n</td>                               
            ...
            <?php foreach ($personaList as $record) { ?>    
                <tr>
                    ...
                    <td style="text-align:center;"><?php if (isset($record->fechainscripcion)) echo date("d/m/Y", strtotime($record->fechainscripcion)); ?></td>
                    <td style="text-align:right;"><?php if (isset($record->montoinscripcion)) echo "$ $record->montoinscripcion"; ?></td>
                </tr>
            <?php } ?>
            </tbody>
        </table>        
        ...
        <div class="row-fluid">
            ...
            <div class="span2 offset6">
                <a id="print" href="<?php echo URL . 'reportes/inscripciones'; ?>" role="button" class="btn btn-info btn-block">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#print').click(function(e){
            e.preventDefault(e);
            $('#inscripcionform').attr("action", "reportes/inscripciones");
            $('#inscripcionform').submit();
        });        
    });    
</script>