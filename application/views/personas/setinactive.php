<div class="well">
    <h2>Clientes <p><small>Desctivar Cliente</small></p></h2>
</div>
<br />
<div class="container" style="margin:0 auto;">
    <div class="alert alert-danger"><h5>&iquest;Est&aacute; seguro que desea Desctivar este Cliente?</h5></div>
    <div class="row">
    ...
    <div class="row-fluid">        
        <form id="setinactivepersonaform" action="<?php echo URL; ?>personas/setinactiveconfirmed" method="POST">
            <fieldset>            
                ...
                <div class="span2 offset6">
                    <button class="btn btn-info btn-block" type="submit" value="submit" name="submit_setinactive_persona" id="submit_setinactive_persona" rel='tooltip' >
                        <i class="icon-fixed-width icon-save"></i> Desactivar
                    </button>
                </div>        
            </fieldset>        
        </form>
