...
class Mensualidades extends FPDF
{
    ...
    function Footer() // Pie de página
    {
        ...
        $txt = 'Concentrado Mensual de Pagos de Clientes por Concepto de Membresía. ';
    ...
    function ImprovedTable($header, $data)
    {
        ...
        foreach($data as $record)
        {
            ...
            $this->Cell($w[2],6,date("d/m/Y", strtotime($record->fecha)),'LR',0,'R');
            $this->Cell($w[3],6,"$ $record->monto",'LR',0,'R');
            $this->Ln();
        }
        // Línea de cierre
    ...
    $pdf = new Mensualidades();  //Crea objeto PDF
    ...
    /* Explicación:
        ...
        * */
    $pdf->Ln(30);
    $pdf->Cell(0,10,'CONCENTRADO MENSUAL DE PAGOS',0,1,'C');
    ...
    * */
    ...
    $header = array('Cliente', 'Nombre', 'Fecha Pago', 'Monto');
    $pdf->ImprovedTable($header, $pagoList);
